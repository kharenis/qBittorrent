...
const initializeWindows = function() {
    ...
    toggleSequentialDownloadFN = function() {
        ...
        if (hashes.length) {
            new Request({
                url: '${BASEPATH}/api/v2p/torrents/toggleSequentialDownload',
                method: 'post',
                data: {
                    hashes: hashes.join("|")
                }
    ...
    toggleFirstLastPiecePrioFN = function() {
        ...
        if (hashes.length) {
            new Request({
                url: '${BASEPATH}/api/v2p/torrents/toggleFirstLastPiecePrio',
                method: 'post',
                data: {
                    hashes: hashes.join("|")
                }
    ...
    setSuperSeedingFN = function(val) {
        ...
        if (hashes.length) {
            new Request({
                url: '${BASEPATH}/api/v2p/torrents/setSuperSeeding',
                method: 'post',
                data: {
                    value: val,
                    hashes: hashes.join("|")
    ...
    setForceStartFN = function() {
        ...
        if (hashes.length) {
            new Request({
                url: '${BASEPATH}/api/v2p/torrents/setForceStart',
                method: 'post',
                data: {
                    value: 'true',
                    hashes: hashes.join("|")
    ...
    pauseFN = function() {
        ...
        if (hashes.length) {
            new Request({
                url: '${BASEPATH}/api/v2p/torrents/pause',
                method: 'post',
                data: {
                    hashes: hashes.join("|")
                }
    ...
    startFN = function() {
        ...
        if (hashes.length) {
            new Request({
                url: '${BASEPATH}/api/v2p/torrents/resume',
                method: 'post',
                data: {
                    hashes: hashes.join("|")
                }
    ...
    autoTorrentManagementFN = function() {
        ...
        if (hashes.length) {
            ...
            new Request({
                url: '${BASEPATH}/api/v2p/torrents/setAutoManagement',
                method: 'post',
                data: {
                    hashes: hashes.join("|"),
                    enable: enable
    ...
    recheckFN = function() {
        ...
        if (hashes.length) {
            new Request({
                url: '${BASEPATH}/api/v2p/torrents/recheck',
                method: 'post',
                data: {
                    hashes: hashes.join("|"),
                }
    ...
    reannounceFN = function() {
        ...
        if (hashes.length) {
            new Request({
                url: '${BASEPATH}/api/v2p/torrents/reannounce',
                method: 'post',
                data: {
                    hashes: hashes.join("|"),
                }
    ...
    torrentSetCategoryFN = function(categoryHash) {
        ...
        if (hashes.length) {
            new Request({
                url: '${BASEPATH}/api/v2p/torrents/setCategory',
                method: 'post',
                data: {
                    hashes: hashes.join("|"),
    ...
    removeCategoryFN = function(categoryHash) {
        const categoryName = category_list[categoryHash].name;
        new Request({
            url: '${BASEPATH}/api/v2p/torrents/removeCategories',
            method: 'post',
            data: {
    ...
    torrentSetTagsFN = function(tagHash, isSet) {
        ...
        if (hashes.length) {
            new Request({
                url: (isSet ? '${BASEPATH}/api/v2p/torrents/addTags' : '${BASEPATH}/api/v2p/torrents/removeTags'),
                method: 'post',
                data: {
                    hashes: hashes.join("|"),
                    tags: tagName,
    ...
    torrentRemoveAllTagsFN = function() {
        ...
        if (hashes.length) {
            new Request({
                url: ('${BASEPATH}/api/v2p/torrents/removeTags'),
                method: 'post',
                data: {
                    hashes: hashes.join("|"),
                }
    ...
    removeTagFN = function(tagHash) {
        ...
        new Request({
            url: '${BASEPATH}/api/v2p/torrents/deleteTags',
            method: 'post',
            data: {
                tags: tagName
            }
    ...
    ['pause', 'resume'].each(function(item) {
        addClickEvent(item + 'All', function(e) {
            new Event(e).stop();
            new Request({
                url: '${BASEPATH}/api/v2p/torrents/' + item,
                method: 'post',
                data: {
                    hashes: "all"
                }
    ...
    setQueuePositionFN = function(cmd) {
        ...
        if (hashes.length) {
            new Request({
                url: '${BASEPATH}/api/v2p/torrents/' + cmd,
                method: 'post',
                data: {
                    hashes: hashes.join("|")
                }
    ...
    addClickEvent('logout', function(e) {
        new Event(e).stop();
        new Request({
            url: '${BASEPATH}/api/v2p/auth/logout',
            method: 'post',
            onSuccess: function() {
    ...
    addClickEvent('shutdown', function(e) {
        ...
        if (confirm('QBT_TR(Are you sure you want to quit qBittorrent?)QBT_TR[CONTEXT=MainWindow]')) {
            new Request({
                url: '${BASEPATH}/api/v2p/app/shutdown',
                onSuccess: function() {
